...
<div class="login-container">
 <header class="login-head">
  ...
  <section class="form">
    ...
    <input name="user" v-validate="'required|min:4|max:16|alpha_dash'" type="text" id="user" placeholder="请输入用户名"
